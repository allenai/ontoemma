...
@Predictor.register('ontoemma-get-embedding')
class OntoEmmaPredictor(Predictor):
    ...
    def _json_to_instance(self, json: JsonDict) -> Instance:
        ...
        # name field
        name_tokens = self._dataset_reader._tokenizer.tokenize('00000 ' + json['canonical_name'])
        ...
        fields['aliases'] = ListField(
            [TextField(self._dataset_reader._tokenizer.tokenize('00000 ' + a),
    ...
    def _get_encoding_for_instance(self, name, aliases, definition, contexts):
        ...
        encoded_name = self._model.name_rnn_encoder(embedded_name, name_mask)

        embedded_aliases = self._model.distributed_name_embedder(aliases)
        aliases_mask = get_text_field_mask(aliases)
        encoded_aliases = TimeDistributed(self._model.name_rnn_encoder)(embedded_aliases, aliases_mask)
